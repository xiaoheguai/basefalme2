...
//	        //存入Shiro会话session
//	        MTokenManager.setVal2Session(VerifyCodeUtils.V_CODE, verifyCode.toLowerCase());
//	        //生成图片
//	        int w = 146, h = 33;
...
//	        MTokenManager.setVal2Session(VerifyCodeUtils.V_CODE, captcha.text().toLowerCase());
//		} catch (Exception e) {
//			LoggerUtils.fmtError(getClass(),e, "获取验证码异常：%s",e.getMessage());
//		}
//	}
