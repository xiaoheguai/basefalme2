...
<div class="kit-doc">
    <form class="layui-form layui-form-pane" action="">
        <input name="id" value="${teacher.id}" hidden="hidden"/>
        <div class="layui-form-item">
            <label class="layui-form-label">账号</label>
            <div class="layui-input-block">
                <input name="loginId" value="${teacher.loginId}" lay-verify="required" placeholder="请输入登陆账号"
                       autocomplete="off"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="loginPwd" value="${teacher.loginPwd}" lay-verify="required" placeholder="请输入登陆账号"
                       autocomplete="off"
                       class="layui-input"
                       type="password">
            </div>
        ...
        <div class="layui-upload">
            ...
            <input class="layui-upload-file"  type="file" accept="undefined" name="touxiang" id="touxiang1">
            <div class="layui-upload-list">
                <img class="layui-upload-img" src="${teacher.touxiang!}" id="demo1">
                <p id="demoText"></p>
            </div>

        </div>

        <input type="hidden" name="touxiang" id="touxiang" value="${teacher.touxiang!}">

        <div class="layui-form-item">
            <label class="layui-form-label">昵称</label>
            <div class="layui-input-block">
                <input name="nickname" value="${teacher.nickname!}" lay-verify="required" placeholder="请输入昵称"
                       autocomplete="off"
                       class="layui-input" type="text">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="mobile" lay-verify="required" value="${teacher.mobile!}" placeholder="请输入手机号"
...
<script>
    layui.use(['form', 'layedit','table','laydate','upload'], function(){
        ...
        form.on('submit(update)', function(data){
            $.post("${basePath}/teacher/update",data.field,function(data){
                // 获取 session
                if(data.status!=200){
