    ...
    <form class="layui-form layui-form-pane" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="discountName" value="${discount.discountName}" lay-verify="required" placeholder="请输入折扣名称"
                       autocomplete="off"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="discountExpression" value="${discount.discountExpression}" lay-verify="required"
                       placeholder="P为当前价格占位" autocomplete="off"
                       class="layui-input"
                       type="text">
            </div>
        </div>
                ...
                <select  id = "goodsTypeId" name="goodsTypeId"  lay-verify="">
                    ...
                    <#list goodsTypes as goodsType >
                        <option value="${goodsType.id}"
                            <#if (goodsType.id == discount.goodsTypeId)>
                                selected="selected"
                            </#if>
                        >${goodsType
                        .typeName}</option>
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" value="${(discount.beginTime?string("yyyy-MM-dd HH:mm:ss"))!}"
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" value="${(discount.endTime?string("yyyy-MM-dd HH:mm:ss"))!}"
        ...
        <div class="layui-form-item">
            ...
            <input type="checkbox" id = "switchopen" lay-filter="ahType" <#if (discount.isOpen == 1)>checked=""</#if> name="switchopen" lay-skin="switch"
                   lay-text="开|关">
            <input type="hidden" id="isOpen" name="isOpen" value="${discount.isOpen}">
        </div>
...
<script>
    layui.use(['form', 'layedit','table','laydate','upload'], function(){
        ...
        form.on('submit(update)', function(data){
            $.post("${basePath}/discount/update",data.field,function(data){
                // 获取 session
                if(data.status!=200){
