    ...
    <form class="layui-form layui-form-pane" action="">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input  id="purchaseNum" name="purchaseNum" lay-verify="required"
                       placeholder="请输入购买数量" 
                       autocomplete="off" 
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input onblur="getDiscountAmount()" id="totalAmount" name="totalAmount" lay-verify="required"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select lay-filter="zhekouchange" id = "discountId" name="discountId" lay-verify="">
                    <option value="">请选择</option>
                    <#list discounts as discount >
                        <option value="${discount.id}" <#if (discount.isOpen==0)
                        >disabled="disabled"</#if>>${discount
                        .discountName}</option>
                    </#list>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input id="discountAmount" readonly name="discountAmount"  placeholder="自动算出不需输入"
                       autocomplete="off"
                       class="layui-input"
                       type="text">
            </div>
                    ...
                    <select lay-filter="addname"  id="customerId" name="customerId" >
                        <option value="">请选择</option>
                         <#list customs as custom >
                             <option value="${custom.id}">${custom.nickname}</option>
                         </#list>
                    </select>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input id="isPayment" value="1" name="isPayment"  placeholder="是否已付款"
                       autocomplete="off"
                       class="layui-input"
                       type="text">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input id="payType" value="0" name="payType"  placeholder="付款方式(0:现金交易1:支付宝2:微信3:刷卡支付)"
                       autocomplete="off"
                       class="layui-input"
                       type="text">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input id="payRecordId"  name="payRecordId"  placeholder="付款记录id"
                       autocomplete="off"
                       class="layui-input"
                       type="text">
            </div>
...
<script>
    layui.use(['form', 'layedit','table','laydate','upload'], function(){
        ...
        form.on('submit(add)', function(data){
            $.post("${basePath}/px/add",data.field,function(data){
                // 获取 session
                if(data.status!=200){
