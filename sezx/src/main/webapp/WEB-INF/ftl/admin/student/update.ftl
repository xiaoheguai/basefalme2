...
<div class="kit-doc">
    <form class="layui-form layui-form-pane" action="">
        <input name="id" value="${student.id}" hidden="hidden"/>
        <div class="layui-form-item">
            <label class="layui-form-label">账号</label>
            <div class="layui-input-block">
                <input name="loginId" value="${student.loginId}" lay-verify="required" placeholder="请输入登陆账号"
                       autocomplete="off"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="loginPwd" value="${student.loginPwd}" lay-verify="required" placeholder="请输入登陆账号"
                       autocomplete="off"
                       class="layui-input"
                       type="password">
            </div>
        ...
        <div class="layui-upload">
            ...
            <div class="layui-upload-list">
                <img class="layui-upload-img" src="${student.touxiang!}" id="demo1">
                <p id="demoText"></p>
            </div>

        </div>

        <input type="hidden" name="touxiang" id="touxiang" value="${student.touxiang!}">

        <div class="layui-form-item">
            <label class="layui-form-label">昵称</label>
            <div class="layui-input-block">
                <input name="nickname" value="${student.nickname!}" lay-verify="required" placeholder="请输入昵称"
                       autocomplete="off"
                       class="layui-input" type="text">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="mobile" lay-verify="required" value="${student.mobile!}" placeholder="请输入手机号"
