...
<div class="kit-doc">
    <form class="layui-form layui-form-pane" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="worksName" id="worksName" lay-verify="required" placeholder="请输入作品名称" autocomplete="off"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="worksDescribe" id="worksDescribe" lay-verify="required" placeholder="请输入作品描述" autocomplete="off"
                       class="layui-input" type="text">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="worksName2" id="worksName2" lay-verify="required" readonly placeholder="请上传视频"
                       autocomplete="off"
                       class="layui-input" type="text">
            </div>
        </div>
        ...
        <input type="hidden" name="worksUrl" id="worksUrl">

        <div class="layui-inline">
            <label class="layui-form-label">申请上架</label>
            <input type="checkbox" id = "switchopen" lay-filter="ahType"  name="switchopen" lay-skin="switch"
                   lay-text="开|关">
            <input type="hidden" id="wanToGoods" name="wanToGoods" value="0">
        </div>
...
<script>
    ...
    layui.use(['form', 'layedit','table','laydate','upload'], function(){
        ...
        form.on('submit(add)', function(data){
            $.post("${basePath}/works/add",data.field,function(data){
                // 获取 session
                if(data.status!=200){
