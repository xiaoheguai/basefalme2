    ...
    <form class="layui-form layui-form-pane" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="questionNo" id="questionNo" value="${test.questionNo!}" lay-verify="required|number"
                       placeholder="请输入题号"
                       autocomplete="off"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="question" id="question" value="${test.question!}" lay-verify="required"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="answer1" id="answer1" value="${answer1!}" placeholder="请输入答案" autocomplete="off"
                       class="layui-input" type="text">
                <input type="radio" name="right" value="1" <#if (istrue==1)>checked="checked"</#if>>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="answer2" id="answer2" value="${answer2!}" placeholder="请输入答案" autocomplete="off"
                       class="layui-input" type="text">
                <input type="radio" name="right" value="2" <#if (istrue==2)>checked="checked"</#if>>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="answer3" id="answer3" value="${answer3!}" placeholder="请输入答案" autocomplete="off"
                       class="layui-input" type="text">
                <input type="radio" name="right" value="3" <#if (istrue==3)>checked="checked"</#if>>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="answer4" id="answer4" value="${answer4!}" placeholder="请输入答案" autocomplete="off"
                       class="layui-input" type="text">
                <input type="radio" name="right" value="4" <#if (istrue==4)>checked="checked"</#if>>
            </div>
        </div>
