    ...
    <form class="layui-form layui-form-pane" action="">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input id="courseName" name="courseName" lay-verify="required" placeholder="请输入课程名" autocomplete="off"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="courseDescribe" lay-verify="required" placeholder="请输入课程描述" autocomplete="off" class="layui-input"
                       type="text">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="courseName2" id="courseName2" lay-verify="required" readonly placeholder="请上传视频"
                       autocomplete="off"
                       class="layui-input" type="text">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="goodsPrice" lay-verify="required" placeholder="请输入价格" autocomplete="off"
                       class="layui-input"
                       type="text">
            </div>
        </div>
...
<script>
    layui.use(['form', 'layedit','table','laydate','upload'], function(){
        ...
        form.on('submit(add)', function(data){
            $.post("${basePath}/rcourse/add",data.field,function(data){
                // 获取 session
                if(data.status!=200){
