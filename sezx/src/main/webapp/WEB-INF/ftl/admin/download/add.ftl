    ...
    <form class="layui-form layui-form-pane"  action="">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="fileName" id="fileName"  lay-verify="required" readonly placeholder="请上传文件" autocomplete="off"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="fileDescribe" id="fileDescribe" lay-verify="required" placeholder="请输入描述" autocomplete="off"
                       class="layui-input"
                       type="text">
            </div>
        </div>
...
<script>
    layui.use(['form', 'layedit','table','laydate','upload'], function(){
        ...
        form.on('submit(add)', function(data){
            $.post("${basePath}/download/add",data.field,function(data){
                // 获取 session
                if(data.status!=200){
