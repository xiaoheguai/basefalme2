...
<div class="kit-doc">
    <form class="layui-form layui-form-pane" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input onchange="totalpricechange()"  id="goodsUnitPrice" readonly name="goodsUnitPrice"
                       lay-verify="required"
                        placeholder="请输入购买数量"
                        autocomplete="off"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input onblur="totalpricechange()" id="goodsAmount" name="goodsAmount"  placeholder="请输入商品数量"
                       autocomplete="off"
                       class="layui-input"
                       type="text">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input id="goodsTotalPrice" readonly name="goodsTotalPrice"  placeholder="自动算出不需输入"
                       autocomplete="off"
                       class="layui-input"
                       type="text">
            </div>
        </div>
        <input type="hidden" name="purchaseXinxiId" value="${pxid}">
...
<script>
    layui.use(['form', 'layedit','table','laydate','upload'], function(){
        ...
        form.on('submit(add)', function(data){
            $.post("${basePath}/pxmx/add",data.field,function(data){
                // 获取 session
                if(data.status!=200){
