...
<body>
  <div class="kit-login">
    <div class="kit-login-bg"></div>
      ...
      <h2 class="kit-login-slogan">欢迎使用 <br> 少儿在线学习网站后台管理系统</h2>
          ...
          <div class="kit-login-row">
            <div class="kit-login-col">
              ...
              <span class="kit-login-input">
                            <input type="text" id="loginName" name="loginName" value="xiaoming@qq.com"
                                   lay-verify="required" placeholder="邮箱" />
                        </span>
            </div>
      ...
      function login() {
          ...
          $.ajax({
              ...
              error:function(e){
                  ...
                  layer.msg('对不起，服务异常',new Function());
              }
          });
      }
  </script>
